...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    img.save(f"RXE/resources/final{userid}.png")
    os.remove(f"RXE/resources/temp{userid}.png")
    os.remove(f"RXE/resources/thumb{userid}.png")
    final = f"RXE/resources/final{userid}.png"
    return final
