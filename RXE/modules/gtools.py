...
from RXE.modules.sql_helper.mute_sql import is_muted, mute, unmute
...
async def gspider(fridaybot):
    ...
    if user:
        ...
        try:
            from RXE.modules.sql_helper.gmute_sql import gmute
        except:
            pass
        try:
...
async def gspider(fridaybot):
    ...
    if user:
        ...
        try:
            from RXE.modules.sql_helper.gmute_sql import ungmute
        except:
            pass
        try:
...
async def handler(rkG):
    if rkG.user_joined or rkG.user_added:
        try:
            from RXE.modules.sql_helper.gmute_sql import is_gmuted
