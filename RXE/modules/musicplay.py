...
from RXEchattitle import CHAT_TITLE
from RXEthumbnail import gen_thumb
from telethon.tl import types
from telethon.utils import get_display_name
from youtubesearchpython import VideosSearch

from RXE import CMD_HANDLER as cmd
from RXE import CMD_HELP
from RXE import PLAY_PIC as fotoplay
from RXE import QUEUE
from RXE import QUEUE_PIC as ngantri
from RXE import (
    add_to_queue,
    bash,
    call_py,
...
@friday.on(friday_on_cmd(pattern="play(?:\s|$)([\s\S]*)"))
...
@friday.on(friday_on_cmd(pattern="vplay(?:\s|$)([\s\S]*)"))
...
@friday.on(friday_on_cmd(pattern="end$"))
...
@friday.on(friday_on_cmd(pattern="skip(?:\s|$)([\s\S]*)"))
...
@friday.on(friday_on_cmd(pattern="pause$"))
...
@friday.on(friday_on_cmd(pattern="resume$"))
...
@friday.on(friday_on_cmd(pattern=r"volume(?: |$)(.*)"))
...
@friday.on(friday_on_cmd(pattern="playlist$"))
