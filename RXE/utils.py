...
from RXE import CMD_LIST, LOAD_PLUG, SUDO_LIST, bot
from RXE.Configs import Config
from RXE.wraptools import am_i_admin, ignore_bot, ignore_fwd, ignore_grp, ignore_pm
from var import Var
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        # support for uniborg
        sys.modules["uniborg.util"] = RXE.utils
        sys.modules["friday.util"] = RXE.utils
        sys.modules["userbot.utils"] = RXE.utils
        sys.modules["userbot.plugins"] = RXE.modules
        mod.Config = Config
        ...
        sys.modules["fridaybot.events"] = RXE.utils
        spec.loader.exec_module(mod)
        # for imports
