...
RUN git clone https://github.com/syahrizalemano/rxeuserbot-master /root/rxeuserbot-master
RUN mkdir /root/rxeuserbot-master/bin/
WORKDIR /root/rxeuserbot-master/
